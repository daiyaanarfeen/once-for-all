...
class FlowersDataProvider(DataProvider):
    ...
    def train_dataset(self, _transforms):
        dataset = FlowersDataset(transforms=_transforms)
        return dataset
    
    def test_dataset(self, _transforms):
        dataset = FlowersDataset(train=False, transforms=_transforms)
        return dataset
